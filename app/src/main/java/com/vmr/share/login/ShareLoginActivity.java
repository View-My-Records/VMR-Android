...
import com.vmr.share.select.SelectActivity;
...
public class ShareLoginActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SEND.equals(action) && mimeType != null) {
            Toast.makeText(this, "Type of intent : " + mimeType, Toast.LENGTH_SHORT).show();
            Toast.makeText(this, "Shared Uri : " + intentUri, Toast.LENGTH_SHORT).show();
        } else {
            // Handle other intents, such as being started from the home screen
            Toast.makeText(this, "nothing received.", Toast.LENGTH_LONG).show();
            // TODO: 12/14/16 If mime-type is ot supported, finish activity with appropriate message
        }
...
//        dbManager.closeConnection();
        Intent intent = SelectActivity.getLauncherIntent(this, userInfo.getRootNodref(), intentUri);
        finish();
